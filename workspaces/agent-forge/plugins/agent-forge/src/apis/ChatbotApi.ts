...
const client = new A2AClient('http://127.0.0.1:10000'); // Replace with your server URL
...
export class ChatbotApi implements IChatbotApi {
  constructor(
    ...
    if (!this.apiBaseUrl) {
      throw new Error('CHATBOT_BACKEND_URL is not provided');
    }
  }
  ...
  public async getAnswer(
    ...
    try {
      ...
      const messages = data.output.values.argocd_output.messages;
